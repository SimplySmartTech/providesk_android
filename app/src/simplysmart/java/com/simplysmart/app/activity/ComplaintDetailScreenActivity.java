...
import com.simplysmart.app.adapter.CommentListAdapter;
import com.simplysmart.app.aws.AWSConstants;
import com.simplysmart.app.aws.Util;
import com.simplysmart.app.config.AppConstant;
import com.simplysmart.app.dialog.AlertDialogComplaintInfo;
...
public class ComplaintDetailScreenActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_complaint_detial_screen);
    ...
    private void initializeView() {
        ...
        commentList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (adapter.getData().get(position).getImage_url() != null
                        && !adapter.getData().get(position).getImage_url().equalsIgnoreCase("")) {
