 ...
 */
public class HelpDeskScreenOpen extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.tab_helpdesk_open, container, false);
        return view;
    }
    ...
    public void onStart() {
        ...
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(UpdateDetails, new IntentFilter("UpdateDetails"));
    }

    @Override
    public void onDestroy() {
        LocalBroadcastManager.getInstance(getActivity()).unregisterReceiver(onComplaintModified);
        LocalBroadcastManager.getInstance(getActivity()).unregisterReceiver(UpdateDetails);
        super.onDestroy();
    }
