...
public class CreateSubComplaintActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_sub_complaint);
        ...
        context = CreateSubComplaintActivity.this;
    ...
    private void createComplaintRequest(NewComplaint newComplaint) {
        CreateRequest.getInstance().createNewComplaint(newComplaint, new ApiCallback<CommonResponse>() {
            ...
            public void onSuccess(CommonResponse response) {
                Toast.makeText(CreateSubComplaintActivity.this, response.getMessage(), Toast.LENGTH_LONG).show();
                Intent intent = new Intent(CreateSubComplaintActivity.this, HelpDeskScreenActivity.class);
            ...
            public void onFailure(String error) {
                Toast.makeText(CreateSubComplaintActivity.this, error, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void setSubCategoryData(final ArrayList<SubCategory> subCategoryData) {
        ...
        ArrayAdapter<SubCategory> subCategoryArrayAdapter = new ArrayAdapter<>(CreateSubComplaintActivity.this,
