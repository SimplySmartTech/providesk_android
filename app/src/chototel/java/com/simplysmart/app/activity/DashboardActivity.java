...
import com.simplysmart.app.adapter.CallPagerAdapter;
import com.simplysmart.app.adapter.DrawerAdapter;
...
import com.simplysmart.app.dialog.AlertDialogUpdateVersion;
import com.simplysmart.app.fragment.ElectricityMeterScreen;
import com.simplysmart.app.fragment.EwalletScreen;
import com.simplysmart.app.fragment.HomeMenuScreen;
import com.simplysmart.app.fragment.PlannerScreen;
import com.simplysmart.app.fragment.SensorInfoList;
import com.simplysmart.app.fragment.SensorInfoTodayList;
import com.simplysmart.app.fragment.WaterMeterScreen;
import com.simplysmart.app.gcm.QuickstartPreferences;
import com.simplysmart.app.model.Items;
import com.simplysmart.app.services.FetchCategories;
import com.simplysmart.app.util.VersionComprator;
...
public class DashboardActivity extends AppCompatActivity {
    ...
    private TextView header_unit_name, header_unit_icon, header_arrow_icon, footer_sign_out, footer_item_icon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuCLickList.put("ewallet", new EwalletScreen());
        ...
        menuCLickList.put("profile", new PlannerScreen());
        ...
        header = (ViewGroup) inflater.inflate(R.layout.side_navigation_header, mDrawerList, false);
        ...
        if ((position - 1) >= 0 && (position - 1) <= menuArray.length - 1) {
            ...
            if (menuArray[position - 1].toLowerCase().equalsIgnoreCase("sensors")) {
                ...
                if (fragment != null) {
                    ...
                    if (position == 1) {
                        fragmentManager.beginTransaction().replace(R.id.frame_container, fragment, fragment.getClass().getSimpleName()).commit();
                    } else {
    ...
    private void getUserInfo() {
        ...
        GlobalData.getInstance().setBookingId(UserInfo.getString("booking_id", ""));
    ...
    protected void onResume() {
        ...
        if (!photoUrl.equalsIgnoreCase("")) {
            Picasso.with(DashboardActivity.this).load(photoUrl).placeholder(R.drawable.circle_white)
        ...
        protected void onPostExecute(String onlineVersion) {
            ...
            if (onlineVersion != null && !onlineVersion.isEmpty()) {
                ...
                if (result > 0 && isRunning && DashboardActivity.this != null) {
                    AlertDialogUpdateVersion.newInstance("New update available!", getResources().getString(R.string.app_name) + " "
                            + getResources().getString(R.string.update_app_message), "Later", "Update")
